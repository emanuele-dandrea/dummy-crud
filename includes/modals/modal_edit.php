      ...
      <div class="modal-body">
        <form action="../../actions/update_product.php" method="post" id="editForm" novalidate>
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="edit_name" name="name" placeholder="Ultra Potato" required>
            <div class="invalid-feedback">Product name is required.</div>
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text">Price €</span>
            <input type="number" class="form-control" id="edit_price" name="price" step="0.01" min="0.01" max="999999.99" required>
